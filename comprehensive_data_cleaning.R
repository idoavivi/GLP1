...
cat("  ✓ Height: 150-220 cm (strict lower bound)\n")
cat("  ✓ BMI: 18-80\n")
...
cat("  ✓ BMI ≥ 30 at baseline (verified with height+weight)\n")
...
cat("  ✓ Excluded patients with baseline BMI <30 (strict quality control)\n\n")
